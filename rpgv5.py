...
#def update high score function
# Open highscore.txt file in read mode
# Read in the high name and high score
# Compare player's score with high score
# Open highscore.txt file in write mode
# Replace name and score in the file
...
def update_high_score(player_name, player_score):
    # Open highscore.txt file in read mode
    with open("highscore.txt", "r") as file:
        # Read in the high name and high score
        high_name, high_score = file.readline().split()
...
# Function for welcome message and menu
def welcome():
...
def main():
    ...
    while menu_choice != 2:
        ...
        if menu_choice == 1:
            ...
            # Display welcome message and menu again
            welcome()
    ...
    if fest_season == '1':
        fest_points += 100
        print(f'You have chosen Summer! You have earned {fest_points} points!')
    elif fest_season == '2':
        fest_points += 200
        print(f'You have chosen Winter! You have earned {fest_points} points')
    elif fest_season == '3':
        fest_points += 300
        print(f'You have chosen Fall! You have earned {fest_points} points')
    elif fest_season == '4':
        fest_points += 400
        print(f'You have chosen Spring! You have earned {fest_points} points')
    else:
    ...
    if fest_location == '1':
        location_points += 100
        print(f'You have chosen Major City! You have earned {location_points} points!')
    elif fest_location == '2':
        location_points += 200
        print(f'You have chosen Isolated Farmland! You have earned {location_points} points')
    elif fest_location == '3':
        location_points += 300
        print(f'You have chosen Popular Beach Destination! You have earned {location_points} points')
    elif fest_location == '4':
        location_points += 400
        print(f'You have chosen Stadium Atmosphere! You have earned {location_points} points')
    else:
        print('Invalid selection. Please choose from 1-4.')
    print()
    # Update total points accumulator
    ...
    if fest_genre == '1':
        genre_points += 100
        print(f'You have chosen Rock Genre! You have earned {genre_points} points!')
    elif fest_genre == '2':
        genre_points += 200
        print(f'You have chosen Pop Genre! You have earned {genre_points} points')
    elif fest_genre == '3':
        genre_points += 300
        print(f'You have chosen Funk Genre! You have earned {genre_points} points')
    elif fest_genre == '4':
        genre_points += 400
        print(f'You have chosen Funk Genre! You have earned {genre_points} points')
    elif fest_genre == '5':
    ...
    if fest_fit == '1':
        outfit_points += 100
        print(f'You have chosen Group Onesies! You have earned {outfit_points} points!')
    elif fest_fit == '2':
        outfit_points += 200
        print(f'You have chosen Minions! You have earned {outfit_points} points')
    elif fest_fit == '3':
        outfit_points += 300
        print(f'You have chosen 5K Participants! You have earned {outfit_points} points')
    elif fest_fit == '4':
        outfit_points += 400
        print(f'You have chosen Big Lebowski! You have earned {outfit_points} points')
    else:
        print('Invalid selection. Please choose from 1-5.\n')
    # Update total points accumulator
    total_points += outfit_points
    print()
    ...
    # Update high score
    update_high_score(user_name, total_points)

    # Thank them for playing
    print(f"{fest_name} is looking great! Thanks for playing!")
